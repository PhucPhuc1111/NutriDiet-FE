...
const SignUp: React.FC = () => {
  return (
    ...
    <div className="rounded-sm border py-10  bg-white shadow-default dark:border-green-800  dark:bg-green-800 ">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mt-6 text-center">
                  <p>
                    Bạn đã có tài khoản?{" "}
                    <Link href="/auth/signin" className="text-lime-700 hover:text-green-900 dark:text-gray-300 dark:hover:text-white">
                      Đăng nhập
                    </Link>
                  </p>
                </div>

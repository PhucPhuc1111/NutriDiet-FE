    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: ["Bệnh nền"], route: "/admin/staff" }
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0  z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-green-800 duration-300 ease-linear text-white lg:translate-x-0 ${

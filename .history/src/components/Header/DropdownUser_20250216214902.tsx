...
const logout = () => {
  ...
  sessionStorage.removeItem("token");  // Nếu bạn lưu token trong sessionStorage

  // Bạn có thể xóa thêm bất kỳ thông tin người dùng nào khác nếu có

  // Chuyển hướng về trang đăng nhập hoặc trang chủ
  const router = useRouter();
  router.push("/login"); // Hoặc "/" nếu bạn muốn chuyển về trang chủ
};

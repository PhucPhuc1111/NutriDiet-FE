...
export const SigninFormSchema = z.object({
  ...
  password: z.string().min(6, { message: "Password must be at least 6 characters." }), // Đảm bảo có ít nhất 6 ký tự
});
...
const SignIn: React.FC = () => {
  const {
    ...
    resolver: zodResolver(SigninFormSchema), // Use zodResolver to validate schema
  });

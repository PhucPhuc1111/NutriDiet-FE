      ...
      <AuthLayout>
        <div className="flex justify-center mt-10">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-green-800 dark:bg-green-800 h-[500px]">
            ...
            className="flex items-center justify-center uppercase active:bg-green-800 hover:bg-blue-900 disabled:bg-blue-900 bg-[#0055C3] w-full py-2 sm:py-4 rounded-lg text-white font-semibold text-sm sm:text-xl">

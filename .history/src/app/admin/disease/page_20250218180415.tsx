...
const AllergyPage: React.FC = () => {
  ...
  const filteredData = data.filter((item) => {
    return item.Disease.toLowerCase().includes(searchText.toLowerCase());
  });
  return (
    <DefaultLayout>
      <div className="">

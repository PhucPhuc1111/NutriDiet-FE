...
const data: DataType[] = [
  {
    DiseaseID: 1,
    DiseaseName: "Benh beo phi",
    Description: "Thức ăn nhanh (hamburger, pizza, khoai tây chiên)
Thực phẩm chế biến sẵn (đồ hộp, đồ ăn đóng gói)
Đồ ngọt (bánh kẹo, nước ngọt, kem)
Thực phẩm nhiều dầu mỡ (chiên, rán)
Thực phẩm chứa nhiều muối (mì ăn liền, snack mặn)",

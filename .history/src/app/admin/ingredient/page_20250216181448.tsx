...
const columns: TableColumnsType<Ingre> = [
  {
    title: "Id",
  ...
  },
  {
   ...
   onFilter: (value: string | boolean | Key, record: Ingre) => {
...
const onChange: TableProps<Ingre>["onChange"] = (
  pagination,
  filters,
  sorter,
  extra
  ...
  return (
    <DefaultLayout>
      <div className="">
        ...
        <Table<Ingre> columns={columns} dataSource={filteredData} onChange={onChange} />
      </div>
    </DefaultLayout>
  );
};

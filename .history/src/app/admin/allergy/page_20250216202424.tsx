...
const AllergyPage: React.FC = () => {
  ...
  // Giả sử useGetAllAllergies trả về đối tượng có trường 'data' chứa Allergy[]
  const { data: response, isLoading, isError } = useGetAllAllergies(currentPage, pageSize, "");

  // Kiểm tra và lấy data từ response
  const allergies = response?.data || [];  // Lấy dữ liệu từ response.data hoặc mặc định mảng rỗng

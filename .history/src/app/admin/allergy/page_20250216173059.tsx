...
const AllergyPage: React.FC = () => {
  ...
  const [pageSize, setPageSize] = useState<number>(10); // Đặt pageSize mặc định là 10
  const [searchTerm, setSearchTerm] = useState("");

  const { data: allergies, refetch, isLoading, isError } = useGetAllAllergies(currentPage, pageSize, searchTerm);

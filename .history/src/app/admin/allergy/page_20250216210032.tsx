...
const AllergyPage: React.FC = () => {
  ...
  const allergies = response?.data || [];  // response có thể là Allergy[] hoặc undefined, nên ta sử dụng kiểu Optional chaining
    ...
    <DefaultLayout>
      <div className="p-4">
        ...
        <Pagination
          ...
          total={100}  // Use total from the response (if available)
        />
      </div>
    </DefaultLayout>
  );

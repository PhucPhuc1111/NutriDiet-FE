...
const AllergyPage: React.FC = () => {
  ...
  const allergies = response?.data || [];  // Check that 'response.data' exists and has the correct structure
      ...
      <div className="p-4">
        ...
        <Table<Allergy>
          ...
          pagination={{
            current: currentPage,
            pageSize: pageSize,
            total: 100, // Replace this with the actual total from the response if available
            onChange: onChange,
        ...
        <Pagination
          ...
          total={100}  // Replace this with the actual total from the response
        />
      </div>
    </DefaultLayout>
  );

...
const AllergyPage: React.FC = () => {
  ...
  // Since useGetAllAllergies now directly returns an array (Allergy[]), we don't need .data
  const { data: allergies, isLoading, isError } = useGetAllAllergies(currentPage, pageSize, searchTerm);
      ...
      <div className="p-4">
        ...
        <Table<Allergy>
          ...
          pagination={{
            current: currentPage,
            pageSize: pageSize,
            total: 100, // Update this to use the total count if available
            onChange: onChange,
        ...
        <Pagination
          ...
          total={100}  // Update this to use the actual total from the response
        />
      </div>
    </DefaultLayout>
  );
